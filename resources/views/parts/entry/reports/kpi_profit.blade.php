...
<h2 class="text-xl font-bold text-gray-800 mb-4">KPI OEM {{ ucfirst(str_replace('kpi_','',"kpi_profit")) }} Report</h2>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            <thead class="bg-gray-50"><tr>
                ...
                @if("kpi_profit" === 'kpi_sale' || "kpi_profit" === 'kpi_profit')
