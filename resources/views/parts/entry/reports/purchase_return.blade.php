...
<h2 class="text-xl font-bold text-gray-800 mb-4">Purchase Return Report</h2>
...
<div class="bg-white rounded shadow-sm border border-gray-200 overflow-hidden">
    <div class="bg-blue-600 p-3 flex justify-between items-center">
        <h3 class="font-semibold text-white">Returned Purchases</h3>
        <span class="text-sm text-white">Grand Total: Rs {{ number_format($total,0) }}</span>
    </div>
