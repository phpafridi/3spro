...
<div class="bg-white rounded shadow-sm border border-gray-200 overflow-hidden">
    <div class="bg-red-600 p-3 flex justify-between">
        <h3 class="font-semibold text-white">{{ $stocks->count() }} stock items</h3>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            <thead class="bg-gray-50"><tr>
                ...
                <th class="px-3 py-2 text-right text-xs text-gray-500 uppercase">Days in Stock</th>
            </tr></thead>
            <tbody class="divide-y divide-gray-100">
                ...
                @empty
                <tr><td colspan="8" class="px-4 py-8 text-center text-gray-400">No dead stock found</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
