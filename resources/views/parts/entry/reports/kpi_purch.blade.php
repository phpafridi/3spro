...
<h2 class="text-xl font-bold text-gray-800 mb-4">KPI OEM {{ ucfirst(str_replace('kpi_','',"kpi_purch")) }} Report</h2>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            <thead class="bg-gray-50"><tr>
                ...
                @if("kpi_purch" === 'kpi_sale' || "kpi_purch" === 'kpi_profit')
