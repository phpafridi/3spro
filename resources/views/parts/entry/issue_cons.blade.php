...
@section('title', 'Issue Consumable — RO #' . $data['RO_no'])
@section('content')
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded shadow-sm border border-gray-200 p-5">
        <h2 class="text-lg font-bold text-gray-800 mb-1">Workshop Consumable Issue</h2>
        ...
        <form action="{{ route('parts.issue-cons-submit') }}" method="POST"
