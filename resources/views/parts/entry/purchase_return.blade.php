...
@section('title', 'Purchase Return - Parts')
@section('content')
<div class="mb-6">
    <h2 class="text-2xl font-bold text-gray-800">Purchase Return Form</h2>
    <p class="text-sm text-gray-500">PRJV #{{ $maxPRJV }}</p>
</div>
...
<div class="space-y-4">
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Invoice / GRN Number <span class="text-red-500">*</span></label>
        <input type="text" name="GRN" required class="w-full border border-gray-300 rounded-xl px-3 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500" placeholder="Original purchase invoice number">
    </div>
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Stock ID <span class="text-red-500">*</span></label>
        <input type="text" name="required_stock_id" id="stockSearch" required autocomplete="off"
               class="w-full border border-gray-300 rounded-xl px-3 py-2.5 text-sm focus:ring-2 focus:ring-indigo-500" placeholder="Search stock...">
    </div>
...
<div class="mt-6">
    <button type="submit" class="w-full bg-gradient-to-r from-red-500 to-rose-600 text-white py-2.5 rounded-xl font-medium hover:from-red-600 hover:to-rose-700 transition-all">Record Purchase Return</button>
</div>
</form>
</div>
</div>
