...
<div class="space-y-4">
    <div>
        ...
        <select name="field" required class="w-full border border-gray-300 rounded px-3 py-2.5 text-sm focus:ring-2 focus:ring-red-500">
    ...
    <div>
        ...
        <input type="text" name="search" required
               class="w-full border border-gray-300 rounded px-3 py-2.5 text-sm focus:ring-2 focus:ring-red-500" placeholder="Enter number...">
    </div>
</div>
<div class="mt-6">
    <button type="submit" class="w-full bg-red-600 text-white py-2.5 rounded font-medium hover:bg-red-700 transition-all">
