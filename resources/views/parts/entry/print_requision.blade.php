...
<div class="space-y-4">
    <div>
        ...
        <select name="model" required class="w-full border border-gray-300 rounded px-3 py-2.5 text-sm focus:ring-2 focus:ring-red-500">
    ...
    <div class="flex items-center gap-2">
        <input type="checkbox" name="consumble" id="consumble" value="1" class="w-4 h-4 text-red-600">
