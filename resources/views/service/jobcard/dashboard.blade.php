...
<div class="bg-white rounded shadow-sm p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded p-5 border border-red-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-red-600 font-medium">Quick Action</p>
            ...
            <a href="{{ route('jobcard.add-vehicle') }}"
               class="mt-4 inline-block bg-red-600 text-white text-sm px-4 py-2 rounded hover:bg-red-600 transition-colors">
                Start Here
            </a>
        </div>

        <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded p-5 border border-emerald-200">
            <div class="flex items-center justify-between">
                <div>
                ...
                <div class="w-12 h-12 bg-emerald-500 rounded flex items-center justify-center">
                    <i class="fa fa-asterisk text-white text-xl"></i>
                </div>
            </div>
            <a href="{{ route('jobcard.index') }}"
               class="mt-4 inline-block bg-emerald-500 text-white text-sm px-4 py-2 rounded hover:bg-emerald-600 transition-colors">
                View All
            </a>
        </div>

        <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded p-5 border border-amber-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-amber-600 font-medium">Estimates</p>
                    <h3 class="text-lg font-bold text-amber-800 mt-1">Create Estimate</h3>
                </div>
                <div class="w-12 h-12 bg-amber-500 rounded flex items-center justify-center">
                    <i class="fa fa-file-text-o text-white text-xl"></i>
                </div>
            </div>
            <a href="{{ route('jobcard.estimate.create') }}"
               class="mt-4 inline-block bg-amber-500 text-white text-sm px-4 py-2 rounded hover:bg-amber-600 transition-colors">
                New Estimate
            </a>
        </div>
    </div>
