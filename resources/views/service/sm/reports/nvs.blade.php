...
@section('title', 'NVS — New Vehicle Sales')
@section('sidebar-menu')@include('service.partials.sm-sidebar')@endsection
@section('content')
<h2 class="text-xl font-bold text-gray-800 mb-4">NVS — New Vehicle Sales</h2>
<p class="text-sm text-gray-500 mb-4">Deliveries by year and month</p>
