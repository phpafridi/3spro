...
@section('title', 'CPUS — Cars Per Unit Served')
@section('sidebar-menu')@include('service.partials.sm-sidebar')@endsection
@section('content')
<h2 class="text-xl font-bold text-gray-800 mb-4">CPUS — Cars Per Unit Served</h2>
<p class="text-sm text-gray-500 mb-4">PM+GR Toyota vehicles by year</p>
