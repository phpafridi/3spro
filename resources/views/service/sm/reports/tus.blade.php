...
@section('title', 'TUS — Toyota Units Serviced')
@section('sidebar-menu')@include('service.partials.sm-sidebar')@endsection
@section('content')
<h2 class="text-xl font-bold text-gray-800 mb-4">TUS — Toyota Units Serviced</h2>
<p class="text-sm text-gray-500 mb-4">PM+GR ROs by year and month</p>
