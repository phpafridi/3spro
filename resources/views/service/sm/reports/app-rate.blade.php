...
@section('title','Appointment Rate')
@section('sidebar-menu')@include('service.partials.sm-sidebar')@endsection
@section('content')
<h2 class="text-xl font-bold text-gray-800 mb-4">Appointment Rate — {{$year}}</h2>
@include('service.sm.reports._filter',['showYear'=>true,'showDates'=>false])
<div class="space-y-5">
    @foreach([['Total ROs',$total,'#dc2626'],['Appointed',$appt,'#15803d']] as [$lbl,$data,$bg])
