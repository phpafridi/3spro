...
@if($jobcards->isEmpty())
    <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded"><i class="fa fa-check-circle mr-2"></i>No jobcards currently in workshop.</div>
@else
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 text-sm">
                            ...
                            @if(!$st)<span class="px-2 py-0.5 bg-gray-100 text-gray-600 text-xs rounded-full">Pending</span>
                            @elseif($st=='Job Assign')<span class="px-2 py-0.5 bg-blue-100 text-blue-700 text-xs rounded-full">Assigned</span>
                            @elseif($st=='Jobclose')<span class="px-2 py-0.5 bg-green-100 text-green-700 text-xs rounded-full">Done</span>
                            @elseif($st=='Job Stopage')<span class="px-2 py-0.5 bg-red-100 text-red-700 text-xs rounded-full">Stopped</span>
                            @elseif($st=='Job Not Done')<span class="px-2 py-0.5 bg-yellow-100 text-yellow-700 text-xs rounded-full">Not Done</span>
                            @else<span class="px-2 py-0.5 bg-gray-100 text-gray-600 text-xs rounded-full">{{ $st }}</span>
                            @endif
                        </td>
