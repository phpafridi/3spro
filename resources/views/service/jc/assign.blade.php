    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('jc.dashboard') }}" class="inline-flex items-center px-4 py-2 bg-white text-blue-600 text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors">
        ...
        <div class="p-6">
            ...
            <form action="{{ route('jc.assign.process') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <select name="category" id="category" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                ...
                <div id="dynamic-fields" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="bay" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select name="team" id="team" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                ...
                <div id="team-members" class="bg-blue-50 rounded-lg p-4 text-sm text-blue-700">
        ...
        if (category === 'Job Not Done') {
            html = `
                <div>
                    ...
                    <select name="remarks" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
