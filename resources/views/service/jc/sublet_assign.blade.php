...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded shadow-sm overflow-hidden">
        <div class="bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('jc.sublet') }}" class="inline-flex items-center px-4 py-2 bg-white text-red-600 text-sm font-medium rounded hover:bg-gray-50 transition-colors">
                ...
                <form action="{{ route('jc.sublet-assign.process') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="parts_details" required rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-red-500 focus:border-purple-500"
                    ...
                    <div>
                        ...
                        <select name="Vendor" required class="w-full px-3 py-2 border border-gray-300 rounded focus:ring-red-500 focus:border-purple-500">
                    ...
                    <div class="flex items-center space-x-3 pt-4 border-t border-gray-200">
                        <button type="submit" class="px-6 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded transition-colors">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="Vendorprice" required step="0.01" min="0"
                                   class="pl-7 w-full px-3 py-2 border border-gray-300 rounded focus:ring-red-500 focus:border-purple-500"
                                   placeholder="0.00">
                        </div>
                    </div>
    ...
    <!-- Vendors List Card -->
    <div class="bg-white rounded shadow-sm overflow-hidden mt-6">
