        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-4 py-3 text-sm font-bold text-gray-900">{{ $u->UIO_Year }}</td>
                    ...
                    <td class="px-4 py-3">
                        <form method="POST" action="{{ route('sales.uio.update') }}" class="flex gap-2 items-center">
                            @csrf
