...
@section('title', 'Sales - Consumable Status')
@section('sidebar-menu') @include('sales.partials.sidebar') @endsection
@section('content')
<div class="flex justify-between items-center mb-4">
    <h2 class="text-xl font-semibold text-gray-800">Consumable Status — In Workshop</h2>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 text-sm text-gray-400">{{ $c->entry_datetime }}</td>
                        <td class="px-4 py-2 text-sm text-gray-400">{{ $c->issue_time ?? '—' }}</td>
