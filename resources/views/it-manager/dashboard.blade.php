...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('css/it-manager.css') }}" rel="stylesheet">
...
<body>
        ...
        <div class="container-fluid">
            <div class="navbar-brand d-flex align-items-center">
               <img src="{{ asset(env('APP_LOGO', 'src/3spro.png')) }}" alt="Logo">
                <span>{{ env('APP_NAME') }} - IT Manager Portal</span>
            </div>
    ...
    <div class="container">
        ...
        <div class="welcome-section">
            ...
            <p class="welcome-subtitle">
                IT Manager Dashboard - Monitor and manage all departments from one place
            </p>

            {{-- FIXED: Properly handle login time and session duration --}}
            @php
                // Ensure login_time is treated as a timestamp
                $login_timestamp = isset($login_time) && is_numeric($login_time) ? $login_time : time();
                $login_time_formatted = date('Y-m-d H:i:s', $login_timestamp);
                $current_time = time();
                $session_duration = $current_time - $login_timestamp;
            ...
            <div class="session-info">
                ...
                Logged in: <strong>{{ $login_time_formatted }}</strong> |
    ...
    <!-- Optional: Add chart library if needed -->
