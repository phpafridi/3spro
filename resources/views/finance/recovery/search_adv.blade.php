...
<div class="bg-white rounded shadow-sm p-6">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">
        <i class="fas fa-search-plus text-red-500 mr-2"></i> Advanced Search
    </h2>
    <form method="GET" action="{{ route('recovery.search-adv') }}" class="flex gap-3 mb-6">
        ...
        <button class="px-5 py-2 bg-red-600 hover:bg-red-700 text-white rounded text-sm font-medium">Search</button>
    </form>
    @if($results !== null)
