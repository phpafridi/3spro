...
<div class="bg-white rounded shadow-sm p-6 max-w-xl">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">
        <i class="fas fa-search text-red-500 mr-2"></i> Search Customer
    </h2>
    <form method="POST" action="{{ route('recovery.search') }}">
        ...
        <div class="space-y-4">
            <div>
                ...
                <select name="required_search" required class="w-full border border-gray-300 rounded px-3 py-2 text-sm">
        ...
        <button type="submit" class="mt-6 w-full py-2 bg-red-600 hover:bg-red-700 text-white rounded font-medium">
            Search
        </button>
    </form>
    <div class="mt-4 text-center">
        <a href="{{ route('recovery.search-adv') }}" class="text-sm text-red-600 hover:underline">
            Advanced Search →
        </a>
    </div>
</div>
