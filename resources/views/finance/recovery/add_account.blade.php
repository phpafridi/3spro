...
<div class="bg-white rounded-2xl shadow-sm p-6 max-w-3xl">
    ...
    <form method="POST" action="{{ route('recovery.add-account.store') }}" class="mb-8 p-5 bg-indigo-50 border border-indigo-200 rounded-xl">
        @csrf
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 font-semibold text-indigo-600">Rs {{ number_format($a->amount_limit) }}</td>
