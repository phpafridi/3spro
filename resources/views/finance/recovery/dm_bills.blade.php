...
<div class="bg-white rounded-2xl shadow-sm p-6">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">
        <i class="fas fa-file-invoice text-indigo-500 mr-2"></i> Pending DM / DMC Bills
    </h2>
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm" id="dmTable">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-yellow-50">
                    <td class="px-3 py-3 font-mono font-bold text-indigo-700">{{ $b->Invoice_id }}</td>
                    ...
                    <td class="px-3 py-3">
                        <a href="{{ route('recovery.add-debt', ['id' => $b->Invoice_id]) }}"
                           class="px-3 py-1 bg-red-100 text-red-700 rounded-lg text-xs hover:bg-red-200 whitespace-nowrap">
