...
<div class="bg-white rounded-2xl shadow-sm p-6 max-w-2xl">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">
        <i class="fas fa-file-invoice-dollar text-orange-500 mr-2"></i> Journal Voucher
    </h2>

    <form method="POST" action="{{ route('accounts.jv') }}">
        @csrf
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Voucher Type</label>
                <input type="text" name="vouchertype" value="JV" readonly
        ...
        <button type="submit" class="mt-6 w-full py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-medium text-sm">
