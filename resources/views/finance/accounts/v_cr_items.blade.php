    ...
    <div class="flex items-center justify-between mb-5">
        <div>
            <h2 class="text-xl font-semibold text-gray-800">
                <i class="fas fa-list text-green-500 mr-2"></i>Cash Receipt Voucher — Line Items
            </h2>
        ...
        <span class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-bold">CRV</span>
    </div>

    {-- Add Line Item Form --}
    <form method="POST" action="{{ route('accounts.crv.items', ['serial_number' => $serialNo]) }}"
        ...
        <button type="submit"
                class="mt-3 px-5 py-1.5 bg-green-600 hover:bg-green-700 text-white rounded-lg text-sm font-medium">
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 font-mono font-bold text-green-700">{{ $item->GSL_code }}</td>
