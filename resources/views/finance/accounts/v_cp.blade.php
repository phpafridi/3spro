...
<div class="bg-white rounded shadow-sm p-6 max-w-2xl">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">
        <i class="fas fa-file-invoice-dollar text-red-500 mr-2"></i> Cash Payment Voucher
    </h2>
    ...
    <form method="POST" action="{{ route('accounts.cpv') }}">
        ...
        <button type="submit" class="mt-6 w-full py-2 bg-red-600 hover:bg-red-700 text-white rounded font-medium text-sm">
