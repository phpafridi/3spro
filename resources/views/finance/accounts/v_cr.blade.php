...
@section('title', 'Cash Receipt Voucher')
@section('content')
<div class="bg-white rounded-2xl shadow-sm p-6 max-w-2xl">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">
        <i class="fas fa-file-invoice-dollar text-green-500 mr-2"></i> Cash Receipt Voucher
    </h2>

    <form method="POST" action="{{ route('accounts.crv') }}">
        @csrf
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Voucher Type</label>
                <input type="text" name="vouchertype" value="CRV" readonly
            ...
            <div>
                ...
                <input type="text" name="voucherno" required placeholder="e.g. 5CRV"
        ...
        <button type="submit" class="mt-6 w-full py-2 bg-green-600 hover:bg-green-700 text-white rounded-xl font-medium text-sm">
