    ...
    <form method="POST" action="{{ route('accounts.brv') }}">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="voucherno" required placeholder="e.g. 5BRV"
        ...
        <button type="submit" class="mt-6 w-full py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-xl font-medium text-sm">
