...
<div class="bg-white rounded-2xl shadow-sm p-6">
    <h2 class="text-2xl font-semibold text-gray-800 mb-4">
        <i class="fas fa-chart-bar text-indigo-500 mr-2"></i>Finance Reports
    </h2>
    ...
    <div class="mb-6 flex items-center gap-3">
        ...
        <div class="relative">
            <input type="text" id="daterange" name="daterange"
                   class="border border-gray-300 rounded-xl px-4 py-2 text-sm w-64 focus:ring-2 focus:ring-indigo-400"
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
        ...
        <form method="POST" action="{{ route('accounts.report.gsl-report') }}" target="_blank">
            ...
            <div class="mb-2">
                <select name="GSL_code" required class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-xs">
            ...
            <button type="submit" onclick="document.getElementById('res_gsl').value=document.getElementById('daterange').value;
                    ...
                    class="w-full py-2 px-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-medium">
        ...
        <form method="POST" action="{{ route('accounts.report.trial-balances') }}" target="_blank">
            ...
            <button type="submit" onclick="document.getElementById('res_trial').value=document.getElementById('daterange').value;"
                    class="w-full py-2 px-3 bg-green-600 hover:bg-green-700 text-white rounded-lg text-xs font-medium">
        ...
        <form method="POST" action="{{ route('accounts.report.trial-bal-gl') }}" target="_blank">
            ...
            <div class="mb-2">
                <select name="GL_name" required class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-xs">
            ...
            <button type="submit" onclick="document.getElementById('res_tbgl').value=document.getElementById('daterange').value;"
                    class="w-full py-2 px-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-medium">
        ...
        <form method="POST" action="{{ route('accounts.report.voucher-type') }}" target="_blank">
            ...
            <div class="mb-2">
                <select name="vch_type" required class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-xs">
            ...
            <button type="submit" onclick="document.getElementById('res_vt').value=document.getElementById('daterange').value;"
                    class="w-full py-2 px-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-xs font-medium">
        ...
        <form method="POST" action="{{ route('accounts.report.profit-loss-dept') }}" target="_blank">
            ...
            <div class="mb-2">
                <select name="dept" required class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-xs"
            ...
            <button type="submit" onclick="document.getElementById('res_pld').value=document.getElementById('daterange').value;"
                    class="w-full py-2 px-3 bg-orange-600 hover:bg-orange-700 text-white rounded-lg text-xs font-medium">
        ...
        <form method="POST" action="{{ route('accounts.report.profit-loss-overall') }}" target="_blank">
            ...
            <button type="submit" onclick="document.getElementById('res_plo').value=document.getElementById('daterange').value;"
                    class="w-full py-2 px-3 bg-rose-600 hover:bg-rose-700 text-white rounded-lg text-xs font-medium">
        ...
        <form method="POST" action="{{ route('accounts.report.cash-flow') }}" target="_blank">
            ...
            <button type="submit" onclick="document.getElementById('res_cf').value=document.getElementById('daterange').value;"
                    class="w-full py-2 px-3 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg text-xs font-medium">
        ...
        <form method="POST" action="{{ route('accounts.report.cash-flow-gsl') }}" target="_blank">
            ...
            <div class="mb-2">
                <select name="GL_id" required class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-xs"
            ...
            <button type="submit" onclick="document.getElementById('res_cfg').value=document.getElementById('daterange').value;"
                    class="w-full py-2 px-3 bg-sky-600 hover:bg-sky-700 text-white rounded-lg text-xs font-medium">
        ...
        <a href="{{ route('accounts.coa') }}"
           class="flex items-center justify-center py-2 px-3 bg-gray-700 hover:bg-gray-800 text-white rounded-lg text-xs font-medium mt-7">
