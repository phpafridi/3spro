...
@section('content')
<div class="bg-white rounded shadow-sm p-6 max-w-md">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">
        <i class="fas fa-percentage text-red-500 mr-2"></i> Auto Update Labor Prices
    </h2>
    <form method="POST" action="{{ route('accountant.labor-auto.update') }}" onsubmit="return confirm('This will update ALL labor prices. Are you sure?')">
        ...
        <div class="mb-4">
            ...
            <select name="whatupdate" class="w-full border border-gray-300 rounded px-3 py-2 text-sm">
        ...
        <div class="mb-6">
            ...
            <input type="number" name="update" step="0.01" min="0.01" max="100" required
                class="w-full border border-gray-300 rounded px-3 py-2 text-sm" placeholder="e.g. 5">
        </div>
