...
class AccountantController extends Controller
{
    ...
    {
        $jobbers        = DB::table('p_jobber')->orderBy('jbr_name')->get();
        ...
        if ($jabberId) {
            $selectedJobber = DB::table('p_jobber')->where('jobber_id', $jabberId)->first();
        ...
        return view('finance.accountant.vendor_ledger', compact(
